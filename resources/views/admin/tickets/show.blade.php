            ...
            <table class="table table-bordered table-striped dark-mode-table">
                ...
                <tr>
                    ...
                    @foreach ($ticket->attachments as $attachment)
                        ...
                        class="text-primary d-block dark-mode-link"><i class="fas fa-paperclip"></i> {{ $attachment->file_name }}</a>
                    @endforeach
                    </td>
                </tr>
                <tr>
                    <th class="dark-mode-th">{{ trans('cruds.ticket.fields.status') }}</th>
                    <td class="dark-mode-td"><span class="badge bg-info dark-mode-badge">{{ $ticket->status->name ?? '' }}</span></td>
                </tr>
                <tr>
                    <th class="dark-mode-th">{{ trans('cruds.ticket.fields.priority') }}</th>
                    <td class="dark-mode-td"><span class="badge bg-warning dark-mode-badge">{{ $ticket->priority->name ?? '' }}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    @forelse ($ticket->comments as $comment)
                        ...
                        <div class="col">
                            ...
                            <a
                                href="mailto:{{ $comment->author_email }}" class="dark-mode-link">{{ $comment->author_name }}</a>
                            <small
