...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="<?php echo e(route('log-viewer::dashboard')); ?>" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> Visor de Logs
        </a>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
                Logs Visor - <span class="badge badge-info"> version <?php echo e(log_viewer()->version()); ?></span>
            </p>
            <p class="text-muted pull-right">
                Developer <i class="fa fa-heart"></i> PROMISE YOUNG
            </p>
        </div>
    </footer>
...
<?php /**PATH C:\wamp64\www\tisoporte\resources\views/vendor/log-viewer/bootstrap-4/_master.blade.php ENDPATH**/ ?>