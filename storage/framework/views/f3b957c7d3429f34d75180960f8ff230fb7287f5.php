...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
        ...
        <?php if(auth()->guard()->check()): ?>
            <ul class="nav-item ml-auto">
                <ul class="text-center">
                    ...
                    <h5 class="text-success mb-0 fs-md-4 fs-5"><?php echo e(Auth::user()->name); ?></h5>
                </ul>
            </ul>
        <?php endif; ?>
    ...
    <script>
        $(function() {
            let logo = "<?php echo e(asset('logo/load.png')); ?>";
...
<?php /**PATH C:\wamp64\www\tisoporte\resources\views/layouts/admin.blade.php ENDPATH**/ ?>